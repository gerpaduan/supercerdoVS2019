...
-- "SuperCerdo" (SQL Server 2008). Confirmado en vivo antes de ejecutar: columnas ausentes, una
-- sola fila en dbo.Empresas (CUIT 20306210786, coincide con el CUIT objetivo), y
-- dbo.AA_AltaEmpresa NO EXISTE en este servidor (OBJECT_ID devuelve NULL) -- por eso este script
-- no incluye ningun ALTER PROCEDURE, a diferencia de la version local.
