...
BEGIN
    ...
    -- Stock Inicial: "Cierre Stock" cargado EXACTO en @fechaDesde (antes: el
    -- mas reciente sin condicion, ignorando @fechaDesde -- fix Hallazgo 2).
    -- Mismo patron que StockCierre usa con @fechaHasta, unas lineas abajo.
