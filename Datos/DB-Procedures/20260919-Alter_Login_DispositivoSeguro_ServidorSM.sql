...
-- como condicion de login"). Version Servidor SM (base SuperCerdo). Verificar en vivo que las columnas faltan antes de ejecutar; aprobacion explicita del usuario por servidor.
