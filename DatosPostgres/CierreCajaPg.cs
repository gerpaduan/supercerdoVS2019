        ...
        public void addOrEditCierreCaja(CierreCaja oCierreCajaE)
        {
            ...
            if (oCierreCajaE.Id <= 0)
            {
                ...
                object nuevoId = DbPg.Scalar(_connectionString, _idEmpresa, sqlInsert, p =>
                {
                    ...
                    p.AddWithValue("cajaInicio", (object)oCierreCajaE.CajaInicio ?? DBNull.Value);
                    p.AddWithValue("ventas", (object)oCierreCajaE.Ventas ?? DBNull.Value);
                    p.AddWithValue("gastos", (object)oCierreCajaE.EgresosCaja ?? DBNull.Value);
                    p.AddWithValue("cajaCierre", (object)oCierreCajaE.CajaCierre ?? DBNull.Value);
                    p.AddWithValue("diferencia", (object)oCierreCajaE.Diferencia ?? DBNull.Value);
                    p.AddWithValue("cajaInicioSiguiente", (object)oCierreCajaE.CajaInicioSiguiente ?? DBNull.Value);
                    p.AddWithValue("importeRetirado", (object)oCierreCajaE.ImporteRetirado ?? DBNull.Value);
