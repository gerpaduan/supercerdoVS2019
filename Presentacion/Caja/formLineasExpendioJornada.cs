...
{
    public partial class formLineasExpendioJornada : Form
    {
        ...
        bool cargar = false;
        public formLineasExpendioJornada()
        {
            InitializeComponent();            
        }

        private void formLineasExpendioJornada_Load(object sender, EventArgs e)
        {
        ...
        private void formLineasExpendioJornada_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            formLineasExpendioJornada frmVentaDuplicar = new formLineasExpendioJornada();
