...
{
    public partial class formTemporalLineaVenta : Form
    {
        ...
        bool cargar = false;
        bool conVentas = false;
        public formTemporalLineaVenta()
        {
        ...
        public void cargarGrilla()
        {
            try
            {
                if (cargar)
                {
                    ...
                    dtVentas = oVentaN.obtenerTemporalLineaVenta(Convert.ToInt32(comboSucursal.SelectedValue.ToString()), 
        ...
        private void formTemporalLineaVenta_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnVerTodas_Click(object sender, EventArgs e)
        {
            ...
            {
                conVentas = false;
                btnVerTodas.Text = "Ver &sin ventas";
            }
            else
            {
                conVentas = true;
                btnVerTodas.Text = "Ver &todos";
            }
            cargarGrilla();
        }
        ...
        {
            formTemporalLineaVenta frmVentaDuplicar = new formTemporalLineaVenta();
