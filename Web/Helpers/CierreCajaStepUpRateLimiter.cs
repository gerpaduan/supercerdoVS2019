...
{
    /// <summary>
    /// Limita los intentos de autorizacion temporal de Cierre de Caja (ver
    /// CajasController.AutorizarAccionCierre) -- mismo patron que LoginRateLimiter,
    /// pero con umbrales propios (3 intentos, 5 minutos de bloqueo) y clave por
    /// SESSION, no por usuario+IP: los 3 intentos son totales para esa sesion en
    /// esta vista, sin importar a que usuario del combo se le probo la contraseña
    /// (si contara por usuario-objetivo, alcanzaria con probar 3 contra cada
    /// persona del combo para esquivar el limite).
    /// </summary>
    internal static class CierreCajaStepUpRateLimiter
    {
