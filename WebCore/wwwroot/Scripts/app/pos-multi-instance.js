// Port literal de Web/Scripts/app/pos-multi-instance.js (batch 7, ver
// docs/10-migracion-aspnet-core/PLAN-POS-UI.md). Sin cambios de logica. Recortado en el uso:
// en WebCore no existe el login de operador de produccion (PosOperadorConfig/requiereOperadorPOS,
// ver header de VentasController.cs) asi que init() se llama siempre, sin la condicion que
// pospone el arranque hasta autenticar operador que tiene el original.
