// Port literal de Web/Scripts/app/table-scroll-sync.js (2026-09-05, ver docs/DECISIONS.md).
// 100% client-side y vainilla (el unico uso de jQuery, linea final, ya chequea window.jQuery
// antes de usarlo -- seguro sin importar el orden de carga). El HTML de las vistas ya migradas
// tenia la clase .js-sync-scroll-body puesta desde que se portaron (fiel al original), pero
// _Layout.cshtml nunca cargaba este script ni el CSS de la barra flotante -- por eso nunca se
// veia, aunque el markup ya estaba listo.
