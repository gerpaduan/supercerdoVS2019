// Port literal de Web/Scripts/app/pos-help.js (batch 7, ver
// docs/10-migracion-aspnet-core/PLAN-POS-UI.md). Sin cambios de logica: los hooks F2-F8 que
// abririan modulos aun no portados (CtasCtes/CalculadoraBilletes/POSCompras/POSEgresos/
// POSFinanzas) degradan solos via runHook -> evento sin listener (no se registran en WebCore).
(function (window, $) {
    'use strict';
