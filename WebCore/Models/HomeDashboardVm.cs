...
{
    // Port literal de Web/Models/HomeDashboardVm.cs (2026-09-07, pedido explicito del usuario --
    // ver docs/DECISIONS.md) para el dashboard post-login (Home/Index) de WebCore. Unico cambio
    // de infraestructura: SelectListItem viene de Microsoft.AspNetCore.Mvc.Rendering (Core) en vez
    // de System.Web.Mvc (clasico) -- misma forma, mismos campos Text/Value.
